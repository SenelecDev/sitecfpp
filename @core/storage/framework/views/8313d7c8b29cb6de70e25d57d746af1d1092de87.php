                    ...
                    <div class="single-post-details-item">
                        ...
                        <div class="entry-content">
                            <ul class="post-meta">
                                ...
                                <li><i class="fa fa-user"></i> <?php echo e($blog_post->user->name ?? __('Anonymous')); ?></li>
                                <li>
                                    <div class="cats">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\zixer-update\@core\resources\views/frontend/pages/blog-single.blade.php ENDPATH**/ ?>