...
<?php if(!empty(get_static_option('home_page_counterup_section_status'))): ?>
    <section class="counterup-area counterup-bg-3"<?php echo render_background_image_markup_by_attachment_id(get_static_option('home_01_counterup_bg_image')); ?>>
        <div class="container">
            <div class="row">
...
<?php /**PATH /home/xgenxchi/public_html/laravel/zixer/@core/resources/views/frontend/home-pages/home-03.blade.php ENDPATH**/ ?>