...
<?php endif; ?>
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('Add New work')); ?>

                            <a class="btn btn-info btn-sm pull-right" href="<?php echo e(route('admin.work')); ?>">All Works</a>
                        </h4>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/zixer/@core/resources/views/backend/pages/works/new.blade.php ENDPATH**/ ?>