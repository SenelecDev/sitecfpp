                    ...
                    <div class="newsletter-form-wrap">
                        <form action="<?php echo e(route('frontend.subscribe.newsletter')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="email" name="email" placeholder="<?php echo e(__('Saisir votre email')); ?>" class="form-control">
                            </div>
...
<?php /**PATH C:\laragon\www\c\@core\resources\views/frontend/partials/newsletter.blade.php ENDPATH**/ ?>