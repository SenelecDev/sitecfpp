<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Catégorie:').' '.$category_name); ?>
                        ...
                        <?php if(count($all_blogs) < 1): ?>
                            <div class="col-lg-12">
                                <div class="alert alert-danger">
                                    <?php echo e(__('Aucun article disponible dans').' '.$category_name.' '.__('Catégorie')); ?>
                            ...
                            <?php $__currentLoopData = $all_blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-latest-news-grid-item margin-bottom-30">
                                        ...
                                        <div class="content">
                                            <ul class="post-meta">
                                                <li><?php echo e(__('Par')); ?> <a href="<?php echo e(route('frontend.blog.single',['id' => $data->id,'any' => Str::slug($data->title)])); ?>"><?php echo e($data->user->name ?? __('Anonyme')); ?></a></li>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\c\@core\resources\views/frontend/pages/blog-category.blade.php ENDPATH**/ ?>