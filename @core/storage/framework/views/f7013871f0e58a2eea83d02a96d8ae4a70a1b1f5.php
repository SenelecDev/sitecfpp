                    ...
                    <div class="contact-form-inner">
                        ...
                        <form action="<?php echo e(route('frontend.contact.message')); ?>" method="post" enctype="multipart/form-data" id="contact_form_submit" class="contact-form">
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-lg-12">
                                     <button class="submit-btn" type="submit"><?php echo e(__('Envoyer')); ?></button>
                                 </div>
                             </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\c\@core\resources\views/frontend/pages/contact-page.blade.php ENDPATH**/ ?>