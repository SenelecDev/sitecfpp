    ...
    <body>
        <div id="notfound">
            <div class="notfound">
                ...
                <h2><?php echo e(__('The page your are looking, is not found!!')); ?></h2>
                <a href="<?php echo e(route('homepage')); ?>"><?php echo e(__('Back to home')); ?></a>
            </div>
        </div>
    </body>
</html>
<?php /**PATH /home/xgenxchi/public_html/laravel/zixer/@core/resources/views/errors/404.blade.php ENDPATH**/ ?>