                ...
                function render_drag_drop_form_field_markup(type,random,formFiledLength){
                    ...
                    if(type == 'select'){
                        markup += '<div class="form-group">\n' +
                            '<label>Options</label>\n' +
                            '<textarea name="select_options[]"  class="form-control max-height-120" cols="30" rows="10" placeholder="Enter Message" ></textarea>\n' +
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/zixer/@core/resources/views/backend/form-builder/order-form.blade.php ENDPATH**/ ?>