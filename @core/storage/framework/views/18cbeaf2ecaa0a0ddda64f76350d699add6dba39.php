...
<header class="header-area header-style-two" >
    ...
    <div class="header-carousel-two">
        ...
        <div class="single-header-carosuel-two-item"<?php echo render_background_image_markup_by_attachment_id($data->image); ?>>
            <div class="container">
...
<?php if(!empty(get_static_option('home_page_counterup_section_status'))): ?>
    <section class="counterup-area counterup-bg-2"<?php echo render_background_image_markup_by_attachment_id(get_static_option('home_01_counterup_bg_image')); ?>>
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="recent-work-nav-area">
                        <ul>
                            <li class="active" data-filter="*"><?php echo e(__('Toutes les réalisations')); ?></li>
                ...
                <?php $__currentLoopData = $all_blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-latest-news-grid-item">
                            ...
                            <div class="content">
                                <ul class="post-meta">
                                    <li><?php echo e(__('Par')); ?> <a href="<?php echo e(route('frontend.blog.single',['id' => $data->id,'any' => Str::slug($data->title)])); ?>"><?php echo e($data->user->name ?? 'Anonymous'); ?></a></li>
                                ...
                                <a href="<?php echo e(route('frontend.blog.single',['id' => $data->id,'any' => Str::slug($data->title)])); ?>" class="readmore"><?php echo e(__('En savoir plus')); ?> <i class="flaticon-right-arrow"></i></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\laragon\www\c\@core\resources\views/frontend/home-pages/home-02.blade.php ENDPATH**/ ?>