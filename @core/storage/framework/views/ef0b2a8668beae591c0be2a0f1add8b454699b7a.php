        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-news-grid-item">
                    ...
                    <div class="content">
                        <ul class="post-meta">
                            <li><?php echo e(__('By')); ?> <a href="<?php echo e(route('frontend.blog.single',['id' => $data->id,'any' => Str::slug($data->title)])); ?>"><?php echo e($data->user->username ?? 'Anonymous'); ?></a></li>
...
<?php /**PATH D:\laragon\www\zixer-update\@core\resources\views/frontend/home-pages/home-01.blade.php ENDPATH**/ ?>