        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="login-form-wrapper">
                    <h3 class="title"><?php echo e(__('Login To Your Account')); ?></h4>
...
<?php endif; ?>
                    <form action="<?php echo e(route('user.login')); ?>" method="post" enctype="multipart/form-data" class="account-form" id="login_form_order_page">
                        ...
                        <div class="form-group btn-wrapper">
                            <button id="login_btn" type="submit" class="submit-btn btn-block"><?php echo e(__('Login')); ?></button>
                        </div>
                        <div class="row mb-4 rmber-area">
                            ...
                            <div class="col-6 text-right">
                                <a href="<?php echo e(route('user.register')); ?>" class="mb-3"><?php echo e(__('Create an account')); ?></a><br>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/zixer/@core/resources/views/frontend/user/login.blade.php ENDPATH**/ ?>