            ...
            <div class="col-12 mt-5">
                ...
                <div class="card">
                    <div class="card-header">
                      ...
                      <a href="<?php echo e(route('admin.languages')); ?>" class="btn btn-xs btn-primary pull-right"><i class="fas fa-angle-double-left">
                          </i><?php echo e(__('All Languages')); ?></a>
                    </div>
                  </div>
                    <div class="card-body">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/zixer/@core/resources/views/backend/languages/edit-words.blade.php ENDPATH**/ ?>