                ...
                <div class="right-content-area"><!-- left content area -->
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo e(route('user.home')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
                            ...
                            <?php else: ?>
                            <li><a href="<?php echo e(route('admin.login')); ?>"><?php echo e(__('Connexion')); ?></a></li>
...
<?php /**PATH C:\laragon\www\c\@core\resources\views/frontend/partials/support.blade.php ENDPATH**/ ?>